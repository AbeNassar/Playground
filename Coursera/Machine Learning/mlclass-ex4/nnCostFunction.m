...
a2 = [ones(m,1), sigmoid(z2)];  %5000x 26
z3 = a2*Theta2';                %5000 x 10
a3 = sigmoid(z3);                %5000 x 10 

%map y in {0..9} to Z2^10
I = eye(num_labels);
...
% Note the line below doesnt work because it includes theta for bias terms
% regTerm = 0.5*lambda/m*(nn_params'*nn_params); 
regTerm = 0.5*lambda/m*(sum(sum(Theta1(:,2:end).^2)) ...
